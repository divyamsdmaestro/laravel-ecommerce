...
<head>
  <meta charset="utf-8">
    ...
    <title>D Shop Admin - Log in </title>
                            ...
                            <form method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
                                ...
                                <div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="email" type="email" name="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email" required autofocus>
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="password" type="password" name="password" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password" required>
									</div>
								</div>
								  <div class="row">
									<div class="col-6">
